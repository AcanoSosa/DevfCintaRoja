...
let myPinguin ={
    name: 'Whiteblack',
    origen: 'Whiteblack the Penguin Sees the World',
    authors: 'H. A. Rey and Margret Rey',
    notes: 'Childrens book about a travelling penguin',
}
...
console.log ('Hola, soy unpingüino y mi nombre es ' + myPinguin.name);
console.log(`Hola, soy unpingüino y mi nombre es ${myPinguin.name}`)
...
myPinguin.graznar= funGrazanr;
function funGrazanr(){
    console.log ('kaww kaww!!');
}
/*
PARA CREAR FUNCIONES ANONIMAS
...
myPinguin.saludar= function(){
    console.log('Hola, soy unpingüino y mi nombre es ' + this.name)
}
myPinguin.saludar();
// -----------------------------------------------------------------------
